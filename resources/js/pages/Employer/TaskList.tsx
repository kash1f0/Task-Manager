                ...
                <tbody>
                    {tasks.map((task: any, index: number) => (
                        <tr key={index}>
                            ...
                            <td>{task.due_date}</td>
                            <td>
                                <Link className="btn btn-outline btn-accent" href={`/employer/employeeList/${task.id}`}>See</Link>
                            </td>
                            <td>
                                <Link className="btn btn-outline btn-accent" href={`/employer/task/edit/${task.id}`}>Edit</Link>
                            </td>
                        </tr>
                    ))}
                </tbody>
